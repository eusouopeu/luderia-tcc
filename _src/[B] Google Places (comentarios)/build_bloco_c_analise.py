...
(_data/processed/bloco_b_planilha_curadoria.csv), independentemente da
...
Saída: _data/processed/bloco_c_avaliacoes_analise.csv
...
OUT_PATH = ROOT / "_data" / "processed" / "[B] Avaliacoes recentes" / "Google Places" / "bloco_c_avaliacoes_analise.csv"
