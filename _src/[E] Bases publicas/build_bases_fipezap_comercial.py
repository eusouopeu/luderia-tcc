...
def main() -> None:
    ...
    serie.to_csv(caminho_saida("Financeiro", "Aluguel e Venda Comercial", rotulo_periodo(serie["data"]), "FipeZap"),
                 index=False)
    ...
    tabela.to_csv(caminho_saida("Financeiro", "Aluguel Comercial por Capital", mes, "FipeZap"), index=False)
