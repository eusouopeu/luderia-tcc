...
Saída: _data/raw/ludopedia_top_ids.csv (id_jogo, ano_publicacao, nota_media, nota_rank, qt_avaliacoes)
...
RANKING_PATH = ROOT / "_data" / "raw" / "[F] Jogos (ludopedia)" / "ludopedia_ranking.csv"
OUT_PATH = ROOT / "_data" / "raw" / "[F] Jogos (ludopedia)" / "ludopedia_top_ids.csv"
