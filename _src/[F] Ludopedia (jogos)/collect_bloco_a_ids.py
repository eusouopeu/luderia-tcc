...
Saída: _data/raw/ludopedia_ids.csv (id_jogo, ano_publicacao, link)
...
OUT_PATH = pathlib.Path(__file__).resolve().parents[2] / "_data" / "raw" / "[F] Jogos (ludopedia)" / "ludopedia_ids.csv"
