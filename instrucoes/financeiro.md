...
Interpretação estratégica do tornado e dos pontos de ruptura: cap. 10 ([anal-riscos.md](anal-riscos.md)).
...
- **Taxa de ocupação e ticket médio costumam concentrar quase todo o risco.** Eles merecem mais evidência que o resto (ver instrumentos em [metodologia.md](metodologia.md)).
...
- Se implementado em Python, seguir o padrão do pipeline em `src/` e exportar resultados para `data/processed/` com prefixo `financeiro_`.
